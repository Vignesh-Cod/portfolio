    ...
    return <section id='Hero' className='flex flex-col md:flex-row px-5  py-32 bg-primary justify-center'>
      ...
      <div className=' md:w-1/2 flex-col'>
        ...
        <div className='flex py-10'>
            <a href="mailto:venkatvignesh72@gmail.com" className='pr-5 hover:text-white'><BiLogoGmail size={40} />
            ...
            <a href='https://www.instagram.com/suveen_003/' className='hover:text-white'><FaInstagram size={40} />
        </div>
        </div>
